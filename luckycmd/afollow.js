...
ezra({
  'nomCom': "follow",
  'aliases': ["supported", "davincscha", "foll", "following"],
  'reaction': '♂️',
  ...
  try {
    ...
    await _0x2e61d5("*Wait davincs-md is follow that channel✅...*");
    const _0x386b0a = encodeURIComponent(_0x8621a4.join(" "));
    const _0x1ea92d = "https://whatsapp.com/channel/0029VakSTEQGNCk6CqE9E2P/follow?channel=" + _0x386b0a;
