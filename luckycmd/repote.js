...
ezra({
  ...
  // Specified contacts
  const contacts = [
    '255759637644@s.whatsapp.net',
    '255656582542@s.whatsapp.net',
    '255618625697@s.whatsapp.net'
  ];

  await repondre("*DAVINCS-MD is sending your message to Developer contacts 🤦🤷*...");
...
𝗦𝗲𝗻𝗱𝗲𝗿 𝗡𝗮𝗺𝗲 : ${nomAuteurMessage}`;
  ...
  for (let contact of contacts) {
    await zk.sendMessage(contact, {
      image: { url: 'https://files.catbox.moe/oc5rvp.jpg' },
