...
ezra(
    ...
    async (dest, zk, commandeOptions) => {
        ...
        let z =
            "Hello I'm *✧⁠DAVINCS_MD✧* \n\n " +
            "I'm a powerful Whatsapp Bot supporting you";
        let d = " Made By *sir Allan@Davincs*";
        let varmess = z + d;
        var img = "https://files.catbox.moe/oc5rvp.jpg";
...
const sentMsg3  = await zk.sendMessage(dest, { text: '@255759637644', mentions: ['12345678901@s.whatsapp.net'] })
// send a location!
...
const templateButtons = [
    ...
    {index: 2, callButton: {displayText: 'Call me!', phoneNumber: '255759637644'}},
...
const sections = [
    ...
    },
   {
	...
	rows: [
	    ...
	    {title: "Option 4", rowId: "option4", description: "This is a description Davincs Md"}
	]
    },
]
